      ...
      <div class="col-md-8">
        ...
        <section class="content">
          ...
          <div class="box">
            ...
            <div class="box-body">
                <?php 
                    $sql= "SELECT * FROM categoria_evento WHERE id_cat = $id ";
                ...
                <form role="form" name="guardar-registro" id="guardar-registro" method="post" action="modelo-categoria.php">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="nombre-categoria" name="nombre-categoria" placeholder="Categoria" value="<?php echo $categoria['cat_evento']; ?>">
                    </div>
                    <div class="form-group">

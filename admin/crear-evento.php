...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Crear Evento
        <small>llene el formulario para crear un evento</small>
      </h1>
    </section>
                ...
                <form role="form" name="guardar-registro" id="guardar-registro" method="post" action="modelo-evento.php">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="titulo-evento" name="titulo-evento" placeholder="Titulo del Evento">
                    </div>
                            ...
                            <?php
                                try {
                                    ...
                                    while ($cat_evento = $resultado->fetch_assoc()){ ?>
                                            <option value="<?php echo $cat_evento['id_cat']; ?>"><?php echo $cat_evento['cat_evento']; ?></option>
                                    <?php }
                                } catch (Exception $e) {
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group date">
                            ...
                            <input type="text" class="form-control pull-right" id="fecha" name="fecha-evento">
                        </div>
                        <!-- /.input group -->
                    </div>

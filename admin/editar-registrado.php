...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Editar Registro de un Usuario Manual
                                        ...
                                        <li class="col-md-4">
                                            <div class="tabla-precio text-center">
                                                ...
                                                <div class="orden">
                                                    ...
                                                    <input value="<?php echo $boletos['pase_dosdias']['cantidad']; ?>" type="number" class="form-control" min="0" id="pase_dosdias" size="3" name="boletos[2dias][cantidad]" placeholder="0">
                            ...
                            <div class="form-group">
                                ...
                                <div id="eventos" class="eventos clearfix">
                                    ...
                                    <?php
                                            ...
                                            $id_eventos = json_decode($eventos, true);
                                            try {
                                                ...
                                                <?php foreach($eventos['eventos'] as $tipo => $evento_dia): ?>
                                                    <div class="col-md-4">
                                                        ...
                                                        <?php foreach($evento_dia as $evento){ ?>
                                                            <label>
                                                                <input <?php echo (in_array($evento['id'], $id_eventos['eventos']) ? 'checked' : ''); ?> type="checkbox" class="minimal" name="registro_evento[]" id="<?php echo $evento['id']; ?>" value="<?php echo $evento['id']; ?>">
